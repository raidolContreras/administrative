...
<div class="card w-full max-w-sm p-6" x-data="loginPage" x-cloak x-show="$store.app.ready">
    ...
    <div x-show="error" x-transition class="mt-4 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700"
         x-text="error"></div>
    ...
    <form class="mt-4 space-y-4" @submit.prevent="submit()">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute inset-y-0 right-0 px-3 text-slate-400 hover:text-slate-600"
